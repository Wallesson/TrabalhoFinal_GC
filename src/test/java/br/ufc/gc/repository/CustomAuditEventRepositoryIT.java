package br.ufc.gc.repository;

import br.ufc.gc.ProjetoGcApp;

import br.ufc.gc.config.Constants;
import br.ufc.gc.config.audit.AuditEventConverter;
import br.ufc.gc.domain.PersistentAuditEvent;
...
import static br.ufc.gc.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
